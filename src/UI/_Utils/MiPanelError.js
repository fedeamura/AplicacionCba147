...
export default class MiPanelError extends React.Component {
  ...
  render() {
    ...
    const colorBoton = this.props.colorBoton || 'green';
      ...
      <View style={[styles.contenedor, { backgroundColor: colorFondo }, this.props.style]}>
        <View style={styles.content}>
          ...
          {this.props.detalle != undefined && (
            <Text style={styles.textoDetalle}>{this.props.detalle}</Text>
          )}
          ...
          {this.props.mostrarBoton == true && (
            <Button rounded bordered
              ...
              <Text style={{ color: colorBoton }}>{this.props.textoBoton}</Text>
            </Button>
          )}
        </View>
      </View >

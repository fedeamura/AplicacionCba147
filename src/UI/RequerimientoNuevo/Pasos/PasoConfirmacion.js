            ...
            <View>
                <View style={{ padding: 16 }}>
                    {this.props.servicio != undefined && (
                        <MiItemDetalle titulo="Categoria" subtitulo={this.props.servicio.nombre} />
                    )}
                    {this.props.motivo != undefined && (
                        <View>
                            <View style={{ height: 8 }} />
                            <MiItemDetalle titulo="Motivo" subtitulo={this.props.motivo.nombre} />
                        </View>
                    )}
                    ...
                    {this.props.ubicacion != undefined && (
                        <View>
                            <View style={{ height: 8 }} />
                            <MiItemDetalle titulo="Descripción" subtitulo="Indep 710 4f" />
                        </View>
                    )}
                </View>

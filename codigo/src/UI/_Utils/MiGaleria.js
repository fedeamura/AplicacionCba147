      ...
      >
        ...
        <Animated.View
          style={{
            ...
            bottom: 0,
            opacity: this.anim,
            transform: [{ scale: this.anim.interpolate({ inputRange: [0, 1], outputRange: [0.7, 1] }) }]
          }}
        >
        ...
        <Animated.View style={{ zIndex: 20, opacity: this.anim }}>
          <MiToolbar dark={true} titulo="Visor de imagenes" onBackPress={this.ocultar} backgroundColor="transparent" />
        </Animated.View>
      </View>
    );
  }

  renderImageComponent(data) {
    return <WebImage style={{ width: "100%", height: "100%" }} resizeMode="contain" source={data.image.source} />;
  }

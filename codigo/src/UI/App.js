...
import UbicacionDescripcion from "@UI/UbicacionDescripcion";
...
export default class App extends React.Component {
  ...
  //             .then(initData => {
  //               alert("Init data" + JSON.stringify(initData));
  ...
  //             })
  //             .catch(error => {
  //               alert("error Init data" + JSON.stringify(error));
  ...
  render() {
    ...
    // const errorVersionAppVisible =
    //   this.isVersionAppValida() == false &&
    //   errorVisible == false &&
    ...
    //       error={
    //         "Hay una actualización de la aplicación disponible. Por favor, actualice para continuar"
    //       }
    //       mostrarBoton={true}
